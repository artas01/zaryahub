...
local GameScripts = {
    ...
    [7523893339] = {
        name = "Windy City RP",
        script = "https://raw.githubusercontent.com/artas01/zaryahub/main/windycityrp.lua"
    },
    [1077961373] = {
        name = "Giant Simulator",
        script = "https://raw.githubusercontent.com/artas01/zaryahub/main/giantsimulator_notmine.lua"
    }
    [18207529184] = {
...
checkKeyButton.MouseButton1Click:Connect(function()
    if keyInput.Text:lower() == "pizza" then
        ...
        local success, err = pcall(function()
            local scriptContent = game:HttpGet(gameData.script)
